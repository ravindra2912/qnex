...
class ProductController extends Controller
{
	...
	function render_product_list(Request $request){
		...
		if($request->category != null){
			$productLists = $productLists->where('products.category_id',$request->category)
						->orWhere('products.sub_category_id', $request->category)
						->orWhere('products.sub_category2_id', $request->category);
		}
