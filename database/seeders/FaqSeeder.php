    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                ...
                'answer' => 'You can reach our customer support team via email at ' . config('const.contactUs.email') . ' or call us at +91 ' . implode(' or +91 ', config('const.contactUs.contact'))
            ],
        ];
