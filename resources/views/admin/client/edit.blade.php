    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.clients.update', $client->id) }}" data-action="back" class="row formaction">
                        @csrf
                        <input type="hidden" name="_method" value="PATCH">
                        <div class="col-md-12 row">
                            <div class="col-md-4" style="justify-items: center;">
                                <div class="avtar">
                                    <img src="{{ getImage($client->image) }}" class="avtar_img" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option value="{{ $value }}" {{ $client->status == $value ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
