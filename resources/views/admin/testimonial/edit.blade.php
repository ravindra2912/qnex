    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" data-action="back" class="row formaction">
                        @csrf
                        <input type="hidden" name="_method" value="PATCH">
                        <div class="col-md-12 row">
                            <div class="col-md-4" style="justify-items: center;">
                                <div class="avtar">
                                    <img src="{{ getImage($testimonial->image) }}" class="avtar_img" />
                            ...
                            <div class="col-md-8 row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $testimonial->name }}" name="name" placeholder="Name" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $testimonial->designation }}" name="designation" placeholder="Designation" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option value="{{ $value }}" {{ $testimonial->status == $value ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Review <span class="error">*</span></label>
                                        <textarea class="form-control" name="review" placeholder="Review" rows="4">{{ $testimonial->review }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
