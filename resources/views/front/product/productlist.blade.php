...
@section('content')
	...
	<style>
		...
		input[name="color"]:checked+label, input[name="size"]:checked+label{
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-12">
							<div class="float-left">
								<p>Showing <b class="text-primary" id="curent_list">0-0</b> of <b class="text-primary" id="records">0</b> results</p>
							</div> 
...
var category = '';
		...
		function load_product_data(page) {
			$.ajax({
				url: '{{ url("/Products/render_product_list?page=") }}'+ page,
				type: "get",
				...
				success: function(result){
					if(result.success){
						...
						$('#product_data').html(result.data);
						$('#curent_list').html(result.counts.from+' - '+result.counts.to);
						$('#records').html(result.counts.total);
