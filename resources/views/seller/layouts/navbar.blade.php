    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
		...
		@if(Auth::user()->role_id == 1)
          <li class="nav-item {{ (request()->routeIs('category*') || Request::segment(2) == 'subcategory' || request()->routeIs('subcategory2*')) ? 'menu-is-opening menu-open ' : '' }}">
            ...
            <ul class="nav nav-treeview" style="{{ (request()->routeIs('category*') || request()->routeIs('subcategory*') || request()->routeIs('subcategory2*')) ? 'display: block;' : 'display: none;' }}">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{ route('subcategory2.index') }}" class="nav-link {{ request()->routeIs('subcategory2*') ? 'active' : '' }}">
		...
		@endif
		  <li class="nav-item">
            <a href="{{ route('contactus.index') }}" class="nav-link {{ request()->routeIs('contactus*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-address-card"></i><p>Contact Us</p>
            </a>
          </li>
            ...
            <p> Lagel Pages </p>
						...
						<li class="nav-item">
							<a href="{{ route('social_links') }}" class="nav-link {{ request()->routeIs('social_links*') ? 'active' : '' }}">
								<i class="nav-icon fas fa-link"></i><p>Social Links</p>
							</a>
						</li>
