          ...
          <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                  <a href="{{ route('subcategory2.create') }}" class="btn btn-primary">Add Sub Category2</a>
                </div>
              <div class="card-body">
                    ...
                    @if(isset($subCategoryLists) && !empty($subCategoryLists))
                      @foreach($subCategoryLists as $subCategoryList)
                        <tr>
						  ...
						  <td>
                            <div class="d-flex">
                              <a href="{{ route('subcategory2.edit',$subCategoryList->id) }}" class="btn btn-primary tableActionBtn editBtn" title="Edit Sub Category2"><i class="right fas fa-edit"></i></a>
                              <form action="{{ route('subcategory2.destroy', $subCategoryList->id) }}" id="deleteForm" method="POST">
                                @csrf
                                @method('DELETE')
                                <a class="btn btn-danger tableActionBtn deleteBtn" title="Delete Sub Category2"><i class="right fas fa-trash"></i></a>
                              </form>
                            </div>
                          </td>
						  @endif
  ...
  <script type="text/javascript">
    ...
    $(".deleteBtn").click(function(){
      Swal.fire({
        title: 'Are you sure?',
        icon: 'error',
        html: "You want to delete this sub category2?",
